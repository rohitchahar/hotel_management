...
<head>
    ...
    <link rel="shortcut icon" href="ricon.png" type="icon" />
...
<section class="section-padding darkSection">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="form">
                    <h3 class="text-center">Please enter your information!</h3>
...
<section class="section-padding darkSection">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
              <a id="mu-order"> <h1 class="sectionHeading">
                <div class="col-lg-6">
